...
foreign export ccall
  lua_xmove_hs :: EntryPoint (CInt -> CInt -> IO CInt)
...
galua_control_hs l tid r cmdPtr = reentryG "galua_control" [cstringArg0 cmdPtr] l tid r $ \vm args ->
